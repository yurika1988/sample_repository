<?php
/* Smarty version 4.5.1, created on 2024-04-21 08:13:55
  from '/Applications/MAMP/htdocs/mvc_app/Views/contact/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_6624cac31baa16_06787333',
...
function content_6624cac31baa16_06787333 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="ja">
...
">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="body" id="body" placeholder="〇〇について"
                                maxlength="200"><?php echo (($tmp = strtr((string)htmlspecialchars((string)$_POST['body'], ENT_QUOTES, 'UTF-8', true), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
